...
static rng_state_t state = { 
    { 0XB0B3F0530767179E,       /* emergency state initialization when nothing else done */
      0XD27EA2D6A24E74A6,
      0X44D20FC093E272A8, 
      0X740D405A8D1938C8 } 
};
...
double rng_to_range_dbl (double low, double high, double val) {
...
double rng_next_range_dbl (double low, double high) {
    return rng_next_double() * (high-low) + low;
}
/*---------------------------------------------------------------------------*/
